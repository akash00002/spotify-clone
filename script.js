    ...
    for (let index = 0; index < array.length; index++) {
        ...
        if (e.href.includes("/songs")) {
            ...
            <div class="cardContent">
                ...
                <div class="cardHeading">${response.title}</div>
                <div class="cardIntro">
...
async function main() {
    ...
    //attach an event listener which play, next and previous 
    ...
    currentSong.addEventListener("timeupdate", () => {
        ...
        // Calculate the seek bar width
        const seekBarWidth = (currentTime / duration) * seekBar.getBoundingClientRect().width;
        circle.style.width = seekBarWidth + "px";
    });
